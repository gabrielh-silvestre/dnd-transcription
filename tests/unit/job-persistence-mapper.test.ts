...
describe("Job persistence mapper", () => {
  it("normaliza ordenacao, timestamp e caminhos relativos no chunk manifest", () => {
    ...
    expect(remappedRecord).toStrictEqual({
      ...record,
  ...
  it("preserva schema persistido e normaliza listas e timestamps no job state", () => {
    ...
    expect(state.createdAt).toBe("2026-01-02T03:04:05.000Z");
    expect(state.updatedAt).toBe("2026-01-02T03:05:06.000Z");
